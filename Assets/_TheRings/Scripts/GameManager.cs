...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField]
    private bool canDragAgain = true;

    public bool IsNoAdsPurchased
    {
        get { return (PlayerPrefs.GetInt("IsNoAdsPurchased", 0) == 1); }
        set
        {
            if (PlayerPrefs.HasKey("IsNoAdsPurchased"))
            {
                PlayerPrefs.GetInt("IsNoAdsPurchased", 0);
            }
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) && canDragAgain) //First touch
        {
            ...
            {
                canDragAgain = false;
                CancelInvoke("EnableCanDragAgainStrictly");
                allowDrag = true;
            }
        }
...
#if UNITY_ANDROID
        //Analytics.Instance.LogScreen("Game Over");
#endif
    }
    ...
    void EnableCanDragAgainStrictly()
    {
        canDragAgain = true;
    }
}
